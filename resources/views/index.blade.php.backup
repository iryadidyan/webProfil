...
<!-- //custom-theme -->
<link href="{{ url('oil/css/bootstrap.css') }}" rel="stylesheet" type="text/css" media="all" />
<link href="{{ url('oil/css/style.css') }}" rel="stylesheet" type="text/css" media="all" />
<link rel="stylesheet" type="text/css" href="{{ url('oil/css/style3.css') }}" /><!--Banner Text-->
<link rel="stylesheet" type="text/css" href="{{ url('oil/css/team.css') }}" /><!--Banner Text-->
<!-- font-awesome-icons -->
<link href="{{ url('oil/css/font-awesome.css') }}" rel="stylesheet">
<!-- //font-awesome-icons -->
				  ...
				  <div class="banner_wthree_agile_info">
				     <section class="rw-wrapper">
						<div class="rw-sentence">
							<span>BKK SMART KARYA </span>
							<br />
							<span>SMK MAARIF NU TIRTO</span>
			...
			<div class="col-md-10 w3_agileits_banner_bottom_grid_left">
				<ul id="flexiselDemo1">
					<li>
						<div class="agileits_w3layouts_banner_bottom_grid">
							<div class="wthree_banner_bottom_grid1">
								<img src="{{url('oil/images/g1.jpg')}}" alt=" " class="img-responsive" />
					...
					<li>
						<div class="agileits_w3layouts_banner_bottom_grid">
							<div class="wthree_banner_bottom_grid1">
								<img src="{{url('oil/images/g2.jpg')}}" alt=" " class="img-responsive" />
								<div class="agileinfo_banner_bottom_grid1_pos">
									<h3>The Oil</h3>
										<p>Real Quality</p>
								</div>
					...
					<li>
						<div class="agileits_w3layouts_banner_bottom_grid">
							<div class="wthree_banner_bottom_grid1">
								<img src="{{url('oil/images/g4.jpg')}}" alt=" " class="img-responsive" />
								<div class="agileinfo_banner_bottom_grid1_pos">
									<h3>The Oil</h3>
										<p>Real Quality</p>
								</div>
					...
					<li>
						<div class="agileits_w3layouts_banner_bottom_grid">
							<div class="wthree_banner_bottom_grid1">
								<img src="{{url('oil/images/g3.jpg')}}" alt=" " class="img-responsive" />
								<div class="agileinfo_banner_bottom_grid1_pos">
									<h3>The Oil</h3>
										<p>Real Quality</p>
								</div>
					...
					<li>
						<div class="agileits_w3layouts_banner_bottom_grid">
							<div class="wthree_banner_bottom_grid1">
								<img src="{{url('oil/images/g5.jpg')}}" alt=" " class="img-responsive" />
								<div class="agileinfo_banner_bottom_grid1_pos">
									<h3>The Oil</h3>
									<p>Real Quality</p>
								</div>
						...
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-body">
									<img src="{{url('oil/images/g4.jpg')}}" alt="">
       ...
       <div class="wthree_services_bottom_left w3ls_banner_bottom_grids">
			<div class="wthree_services_bottom_left_grid">
				...
				<div class="col-md-4 w3_agileits_services_bottom_l_grid">
					...
					<div class="col-md-4 w3_agileits_services_bottom_l_grid">
					<div class="agile_services_bottom_l_grid1">
						<img src="{{url('oil/images/g6.jpg')}}" alt=" " class="img-responsive" />
						<div class="w3_service_bottom_grid_pos">
							<h3>Oil Industry</h3>
						</div>
					</div>
   ...
   <div class="container">
       ...
       <div class="w3ls_banner_bottom_grids">
			<div class="col-md-3 agileits-team-grid">
						<div class="team-info">
							<img src="{{url('oil/images/t1.jpg')}}" alt="">
					...
					<div class="col-md-3 agileits-team-grid">
						<div class="team-info">
							<img src="{{url('oil/images/t4.jpg')}}" alt="">
							<div class="team-caption">
								<h4>Steven Wilson</h4>
								<p>Worker</p>
								<ul>
					...
					<div class="col-md-3 agileits-team-grid">
						<div class="team-info">
							<img src="{{url('oil/images/t2.jpg')}}" alt="">
							<div class="team-caption">
								<h4>Kate Winslet</h4>
								<p>Supervisor</p>
								<ul>
					...
					<div class="col-md-3 agileits-team-grid">
						<div class="team-info">
							<img src="{{url('oil/images/t3.jpg')}}" alt="">
							<div class="team-caption">
								<h4>Justo Congue</h4>
								<p>Worker</p>
								<ul>
						...
						<div class="agileits_testimonial_grid">
							<div class="w3l_testimonial_grid">
								...
								<div class="w3l_testimonial_grid_pos">
									<img src="{{url('oil/images/1.png')}}" alt=" " class="img-responsive" />
								</div>
							</div>
						</div>
						<div class="agileits_testimonial_grid">
							<div class="w3l_testimonial_grid">
								...
								<h4>Laura Paul</h4>
									<h5>Client</h5>
								<div class="w3l_testimonial_grid_pos">
									<img src="{{url('oil/images/2.png')}}" alt=" " class="img-responsive" />
								</div>
							</div>
						</div>
						<div class="agileits_testimonial_grid">
							<div class="w3l_testimonial_grid">
								...
								<h5>Client</h5>
								<div class="w3l_testimonial_grid_pos">
									<img src="{{url('oil/images/3.png')}}" alt=" " class="img-responsive" />
								</div>
							</div>
						</div>
				</section>
...
<!-- //bootstrap-pop-up -->
<!-- js -->
<script type="text/javascript" src="{{url('oil/js/jquery-2.1.4.min.js')}}"></script>
<!-- carousal -->
	<script src="{{url('oil/js/slick.js')}}" type="text/javascript"></script>
...
<!-- flexisel -->
	...
	<script type="text/javascript" src="{{url('oil/js/jquery.flexisel.js')}}"></script>
<!-- //flexisel -->
<!-- odometer-script -->
			<script src="{{url('oil/js/odometer.js')}}"></script>
			<script>
...
<script type="text/javascript" src="{{url('oil/js/move-top.js')}}"></script>
<script type="text/javascript" src="{{url('oil/js/easing.js')}}"></script>
<script type="text/javascript">
...
<!-- for bootstrap working -->
	<script src="{{url('oil/js/bootstrap.js')}}"></script>
<!-- //for bootstrap working -->
</body>
</html>
